...
/// <summary>A named count used by the live dashboard charts.</summary>
public record DashboardBreakdownDto(string Label, int Count);

/// <summary>A recent task with the trainee name included for dashboard activity.</summary>
public record DashboardRecentTaskDto(
    int Id,
    string Title,
    string TraineeName,
    DateOnly DueDate,
...
/// <summary>
/// Database-backed administration summary. Department administrators receive a
/// department-scoped result; super administrators receive the organization-wide result.
/// </summary>
public record AdminDashboardDto(
    ...
    bool IsSuperAdmin,
    int TotalTrainees,
    int CurrentYearTrainees,
    int ActiveTrainees,
    int InactiveTrainees,
    int VerifiedTrainees,
    int TotalTasks,
    int PendingTasks,
    int InProgressTasks,
    int CompletedTasks,
    int NeedsChangesTasks,
    int CompletionRate,
    IReadOnlyList<string> InternshipDepartments,
    string? TopDepartment,
    IReadOnlyList<DashboardBreakdownDto> DepartmentBreakdown,
    IReadOnlyList<DashboardBreakdownDto> UniversityBreakdown,
    IReadOnlyList<DashboardBreakdownDto> InternshipProgramBreakdown,
    IReadOnlyList<DashboardRecentTaskDto> RecentTasks
);
