...
)
{
    public static TaskDto From(TrainingTask t) => new(
        ...
        t.SubmissionName, t.SubmissionName, t.SubmissionType, t.SubmissionSize,
        t.AdminReview);
}
...
)
{
    public static TraineeDto From(User u) => new(
        u.Id, u.Name, u.Email, u.InternshipProgram, u.Phone, u.Department, u.University, u.JoinDate, u.Status);
}
