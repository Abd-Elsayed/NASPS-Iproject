...
public class NotificationsController(NaspsDbContext db) : ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<NotificationDto>>> GetAll()
    {
        ...
        var items = await db.Notifications.AsNoTracking()
            .Where(n => n.RecipientId == me || n.RecipientId == null)
    ...
    public async Task<IActionResult> MarkRead(int id)
    {
        ...
        var notification = await db.Notifications
            .FirstOrDefaultAsync(n => n.Id == id && (n.RecipientId == me || n.RecipientId == null));
    ...
    public async Task<IActionResult> MarkAllRead()
    {
        ...
        await db.Notifications
            .Where(n => !n.Read && (n.RecipientId == me || n.RecipientId == null))
